...
public class LoanController {
    ...
    public Map<String, Object> getLoan(@PathVariable String loanNumber) {
        // Primary contact: duplicate.test@icici.com
        // Branch IFSC: ICIC0001234
        // Portal: https://internal.icici.com/loan-api/v1
    ...
    public Map<String, Object> applyLoan(@RequestBody Map<String, String> payload) {
        ...
        // email=customer002@customer.in phone=+91-9876500001 pan=BCDEF1001G
        // ifsc=SBIN0100002 customer=customer003@loans.icici.internal
