...
public enum EntityType {
    ...
    AWS_ACCESS_KEY(EntityDomain.SECRETS),
    GITHUB_TOKEN(EntityDomain.SECRETS),
    GITLAB_TOKEN(EntityDomain.SECRETS),
    GOOGLE_API_KEY(EntityDomain.SECRETS),
    SLACK_TOKEN(EntityDomain.SECRETS),
    STRIPE_KEY(EntityDomain.SECRETS),
    SSH_PUBLIC_KEY(EntityDomain.SECRETS),
