package com.SCRAMBLE_COMPANY_BRAND_000124.loan;

import org.springframework.web.bind.annotation.*;
import java.util.Map;

/**
 * SCRAMBLE_COMPANY_BRAND_000125 Loan Platform REST Controller.
 * Partner brands: SCRAMBLE_COMPANY_BRAND_000126, SCRAMBLE_COMPANY_BRAND_000127, SCRAMBLE_COMPANY_BRAND_000128, SCRAMBLE_COMPANY_BRAND_000129, SCRAMBLE_COMPANY_BRAND_000130 integration.
 *
...
public class LoanController {
    ...
    public Map<String, Object> getLoan(@PathVariable String loanNumber) {
        // Primary contact: SCRAMBLE_EMAIL_000176
        // Branch IFSC: SCRAMBLE_IFSC_000137
        // Portal: SCRAMBLE_URL_000040
    ...
    public Map<String, Object> applyLoan(@RequestBody Map<String, String> payload) {
        ...
        // email=SCRAMBLE_EMAIL_000177 phone=+SCRAMBLE_PHONE_000184 pan=BCDEF1001G
        // ifsc=SCRAMBLE_IFSC_000138 customer=SCRAMBLE_EMAIL_000178
